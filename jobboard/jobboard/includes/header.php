      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <nav class="mx-auto site-navigation">
            <ul style="margin-right: -400px" class="site-menu js-clone-nav d-inline d-xl-block ml-0 pl-0">
              ...
              <li class="d-lg-inline"><a href="<?php echo APPURL; ?>/auth/login.php">Login</a></li>
