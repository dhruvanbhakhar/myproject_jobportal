...
<?php 
    ...
    if(isset($_POST['submit'])) {
      ...
      OR empty($_POST['job_category'])) 
        ...
        $insert = $conn->prepare("INSERT INTO jobs (job_title, job_region, job_type, vacancy, 
        job_category, 
        experience, salary, gender, application_deadline,
         job_description, responsibilities, education_experience, other_benifits, company_email, company_name, company_id, company_image) VALUES(
          :job_title, :job_region, :job_type, :vacancy, 
          :job_category, 
          :experience, :salary, :gender, :application_deadline,
        ...
        <div class="row mb-5">
          <div class="col-lg-12">
            <form class="p-4 p-md-5 border rounded" action="post-job.php" method="post">
              ...
              <!-- <h3 class="text-black my-5 borader-bottom pb-2">Company Details    </h3>
              <div class="form-group"> -->
              <!-- <label  for="">Company Email</label>  -->
                <input type="hidden" name="company_email" value="<?php echo $_SESSION['email']; ?>"  class="form-control" id="" placeholder="Company Email">
              </div>

              <div class="form-group">
              <!-- <label class="text-black" for="">Company Name</label>  -->
                <input type="hidden" name="company_name" value="<?php echo $_SESSION['username']; ?>" class="form-control" id="" placeholder="Company Name">
              </div>

              <div class="form-group">
              <!-- <label class="text-black" for="">Company ID</label>  -->
