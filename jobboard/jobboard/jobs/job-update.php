          ...
          <div class="col-lg-12">
            <form class="p-4 p-md-5 border rounded" action="job-update.php?id=<?php echo $id; ?>" method="post">
              ...
              <div class="form-group">
                ...
                <select name="job_region" <?php echo $singleJob->job_region; ?> class="selectpicker border rounded" id="job-region" data-style="btn-black" data-width="100%" data-live-search="true" title="Select Region">
              ...
              <div class="form-group">
                ...
                <select name="job_type" <?php echo $singleJob->job_type; ?> class="selectpicker border rounded" id="job-type" data-style="btn-black" data-width="100%" data-live-search="true" title="Select Job Type">
              ...
              <div class="form-group">
                ...
                <select name="job_category" <?php echo $singleJob->job_category; ?> class="selectpicker border rounded" id="job-type" data-style="btn-black" data-width="100%" data-live-search="true" title="Select Job Category">
              ...
              <div class="form-group">
                ...
                <select name="salary" <?php echo $singleJob->salary; ?> class="selectpicker border rounded" id="job-type" data-style="btn-black" data-width="100%" data-live-search="true" title="Select Salary">
              ...
              <div class="form-group">
                ...
                <select name="gender" <?php echo $singleJob->gender; ?> class="selectpicker border rounded" id="" data-style="btn-black" data-width="100%" data-live-search="true" title="Select Gender">
                  <option>Male</option>
