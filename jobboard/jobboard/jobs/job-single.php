...
// echo $checking_for_saved_jobs->rowCount();
}
        ...
        <div class="d-flex align-items-center">
          <div class="border p-2 d-inline-block mr-3 rounded">
            <img style="width:100px; height:100px; margin-bottom:10px"
              src="../users/user-imges/<?php echo $row->company_image; ?>" alt="Image">
          </div>
          <div>
            <h2>
              <?php echo $row->job_title; ?>
      ...
      <div class="row">
            ...
            <?php if (isset($_SESSION['type']) and $_SESSION['type'] == "Worker"): ?>
              <div class="row mb-5">
                ...
                <?php if($checking_for_saved_jobs->rowCount() == 0) : ?>
                  <div class="col-6">
                    <a href="job-save.php?job_id=<?php echo $id; ?>&worker_id=<?php echo $_SESSION['id']; ?>&status=save" style="padding: 13px 157px; margin-top: 7px; "  class="btn btn-inline btn-light btn-md"><i class="icon-heart"></i>Save
                      Job</a>
                  </div>
                  <?php else : ?>
                    <div class="col-6">
                    <a href="job-save.php?job_id=<?php echo $id; ?>&worker_id=<?php echo $_SESSION['id']; ?>&status=delete" style="padding: 13px 157px; margin-top: 7px; "  class="btn btn-inline btn-light btn-md"><i class="icon-heart text-danger"></i>  Saved Job</a>
                  </div>
                  <?php endif; ?>
                ...
                <form action="job-single.php?id=<?php echo $id; ?>" method="post">
                  ...
                  <div class="col-6">
                    <button style="padding: 13px 157px; margin-top: 7px; " name="submit_application" type="submit"
                      class="btn btn-inline btn-primary btn-md">Apply Now</button>
                  </div>
                </form>
              
                <?php else: ?>
                  <div class="col-6">
                  <h4 style="margin-top: 7px;" class="d-inline ">You applied for this job</h4>
                  </div>
                  <?php endif; ?>
              </div>
            ...
            <?php if (isset($_SESSION['type']) and $_SESSION['type'] == "Company"): ?>
              <?php if (isset($_SESSION['id']) and $_SESSION['id'] == $row->company_id): ?>
                <div class="row mb-5">
                  ...
                  <div class="col-6">
                    <a href=" <?php echo APPURL; ?>/jobs/job-delete.php?id=<?php echo $row->id; ?> "
        ...
        <div class="col-lg-4">
          ...
          <div class="bg-light p-3 border rounded">
            ...
            <div class="px-3">
              <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo APPURL; ?>/jobs/job-single.php?id=<?php echo $row->id; ?>&quote=<?php echo $row->job_title; ?>"
          ...
          <div class="bg-light p-3 border rounded mb-4 mt-4 ">
            ...
            <ul class="list-unstyled pl-3 mb-0">
             ...
             <a targer="_blank" style="text-decoration:none" href="<?php echo APPURL; ?>/categories/show-jobs.php?name=<?php echo $category->name; ?> " > <li class="mb-2"><strong class="text-black"><?php echo ucfirst($category->name); ?></li></a>
              <?php endforeach; ?>
      ...
      <?php foreach ($related_jobs as $job): ?>
        <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
          ...
          <div class="job-listing-logo">
            <img src="../users/user-imges/<?php echo $job->company_image; ?>" alt="Image" class="img-fluid">
          </div>
