          ...
          <div class="col-md-7">
            <div class="card p-3 py-4">
                    ...
                    <div class="text-center">
                        <img src="user-imges/<?php echo $profile->img; ?>" width="100" class="rounded-circle">
                    </div>
                    ...
                    <a class="btn btn-success" href="<?php echo APPURL; ?>/users/user-cvs/<?php echo $profile->cv; ?>" role="button" download> Download CV</a>
                    <?php endif; ?>
      ...
      <div class="container">
        ...
        <div class="row mb-5 justify-content-center">
          <div class="col-md-7 text-center">
            <h2 class="section-title mb-2">Jobs Posted by Company</h2>
          </div>
        </div>
        <?php endif; ?>      
        ...
        <ul class="job-listings mb-5">
          ...
          <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
            ...
            <div class="job-listing-logo">
              <img src="user-imges/<?php echo $_SESSION['image']; ?>" alt="Free Website Template by Free-Template.co" class="img-fluid">
            </div>
