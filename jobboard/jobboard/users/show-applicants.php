  ...
  <div class="container">
    <ul class="job-listings mb-5">
      ...
      <li style="widht:100px; height: 100px" class="d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
        ...
        <a style="text-decoration: none;" class="" targer="_blank" href="<?php echo APPURL; ?>/jobs/job-single.php?id=<?php echo $jobApp->job_id; ?>">
          <img style="widht:100px; height: 100px" src="user-imges/<?php echo $_SESSION['image']; ?>"
        ...
        <div class="d-sm-flex custom-width w-100 justify-content-between mx-4">
          ...
          <div class="job-listing-meta">
            <a style="text-decoration: none;" class="" targer="_blank" href="<?php echo APPURL; ?>/users/public-profile.php?id=<?php echo $jobApp->worker_id; ?>">
