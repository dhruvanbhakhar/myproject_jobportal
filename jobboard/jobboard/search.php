    ...
    <div class="container"> 
        ...
        <ul class="job-listings mb-5">
            <?php if (count($searchRes) > 0) : ?>
                <?php foreach ($searchRes as $oneJob): ?>
                    <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
                        ...
                        <div class="job-listing-logo">
                            <img src="users/user-imges/<?php echo $oneJob->company_image; ?>"
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <div class="alert alert-danger bg-danger text-white"> there are no seaches with this job just yet </div>
            <?php endif; ?>
